...
func createAdminActionConditionKeyMap() map[Action]condition.KeySet {
	...
	return map[Action]condition.KeySet{
		...
		SetBucketTargetAction:          condition.NewKeySet(append(allSupportedAdminKeys, condition.AdminBucket.ToKey())...),
		GetBucketTargetAction:          condition.NewKeySet(append(allSupportedAdminKeys, condition.AdminBucket.ToKey())...),
